                    ...
                    <div class="col-lg-4">
                        <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                                <img src="{{ isset(Auth::user()->avatar) ? asset(Auth::user()->avatar) : asset('build/images/user-dummy-img.jpg') }}" alt="" class="avatar-md rounded-circle img-thumbnail">
                            </div>
                            <div class="flex-grow-1 align-self-center">
                                <div class="text-muted">
                                    <p class="mb-2">Hino Karoseri Dashboard</p>
                                    <h5 class="mb-1">{{ ucfirst(session('Username')) }}</h5>
                                    <p class="mb-0">{{ strtoupper(session('Roles')) }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div>
                                        ...
                                        <h5 class="mb-0">{{ $response['data']['visitors']['weekly'] }}</h5>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div>
                                        <p class="text-muted text-truncate mb-2">Monthly Visitor</p>
                                        <h5 class="mb-0">{{ $response['data']['visitors']['monthly'] }}</h5>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div>
                                        <p class="text-muted text-truncate mb-2">Total Visitor</p>
                                        <h5 class="mb-0">{{ $response['data']['visitors']['total'] }}</h5>
            ...
            <div class="card-body ">
                <div class="d-flex">
                    <div class="flex-grow-1">
                        ...
                        <h4 class="mb-0 text-white">{{ $response['data']['request'][0]['approve'] }}</h4>
                    </div>
            ...
            <div class="card-body ">
                <div class="d-flex">
                    <div class="flex-grow-1">
                        ...
                        <h4 class="mb-0 text-white">{{ $response['data']['request'][0]['reject'] }}</h4>
                    </div>
    ...
    fetch("{{ route('yajra') }}")
        ...
        $(document).on('click', '#button-submit', function() {
            ...
            if (rejectNote === '') {
                ...
                window.location.href = `{{ 'approval' }}?${url}`;
            }
        });
</script>
@endsection