...
<!-- App js -->
<script src="<?php echo e(URL::asset('build/js/plugin.js')); ?>"></script><?php /**PATH /Volumes/Secondary/PHP/Laravel/Apps/Hino/resources/views/layouts/head-css.blade.php ENDPATH**/ ?>